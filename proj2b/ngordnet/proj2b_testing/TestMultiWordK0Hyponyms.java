...
public class TestMultiWordK0Hyponyms {
    ...
    public static final String WORDS_FILE = "data 2/ngrams/very_short.csv";
    public static final String TOTAL_COUNTS_FILE = "data 2/ngrams/total_counts.csv";
    public static final String SMALL_SYNSET_FILE = "data 2/wordnet/synsets16.txt";
    public static final String SMALL_HYPONYM_FILE = "data 2/wordnet/hyponyms16.txt";
    public static final String LARGE_SYNSET_FILE = "data 2/wordnet/synsets.txt";
    public static final String LARGE_HYPONYM_FILE = "data 2/wordnet/hyponyms.txt";
