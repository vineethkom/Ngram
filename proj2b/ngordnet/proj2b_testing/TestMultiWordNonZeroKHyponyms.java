...
public class TestMultiWordNonZeroKHyponyms {
    public static final String WORDS_FILE = "data 2/ngrams/top_14377_words.csv";
    public static final String TOTAL_COUNTS_FILE = "data 2/ngrams/total_counts.csv";
    public static final String SYNSET_FILE = "data 2/wordnet/synsets.txt";
    public static final String HYPONYM_FILE = "data 2/wordnet/hyponyms.txt";
